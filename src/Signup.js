    ...
    <Container fluid style={{ height: "100vh" }}>
      <Row style={{ height: "5vh" }}>
        <Col xs={8} md={6} lg={7} xl={7}>
          <p className="m-3" style={{ fontSize: "3vh", color: 'white' }}>
            POLLING BOOTH
          </p>
        </Col>
        <Col xs={4} md={6} lg={5} xl={5} className="d-flex justify-content-end">
          <button onClick={Loginbut} className="login-button" style={{ width: '100%', maxWidth: '100px' }}>
            Login
          </button>
        </Col>
      </Row>

      <Row className="" style={{ height: "95vh" }}>
        <Col xs={12} md={4} lg={4} className="d-none d-md-block"></Col>

        <Col xs={12} md={5} lg={4}>
          <Card className='cardcolor'>
            <h2 style={{ color: '#e5e5e5' }} className="text-center mb-4">CREATE YOUR ACCOUNT!</h2>
            <form onSubmit={Handlesubmit}>
              <div>
                {!addph && (
                  <>
                    <div className="mb-3">
                      <label className="form-label" style={{ color: '#e5e5e5' }}>Name:</label>
                      <input
                        type="text"
                        id="user_name"
                        name="user_name"
                    ...
                    <div className="mb-3">
                      <label htmlFor="email" style={{ color: '#e5e5e5' }} className="form-label">
                        Email:
                      </label>
                      <input
                        type="email"
                    ...
                    <Row className="mb-3">
                      <Col>
                        <label style={{ color: '#e5e5e5' }} htmlFor="dob" className="form-label">
                          Age:
                        </label>
                        <input
                          type="date"
                      ...
                      <Col>
                        <label style={{ color: '#e5e5e5' }} htmlFor="gender" className="form-label">
                          Gender:
                        </label>
                        <select
                          id="gender"
                          name="gender"
                          value={state1.gender}
                          className="form-select inputforsign"
                          onChange={HandleChange}
                        >
                    ...
                    <div className="mb-3">
                      <label style={{ color: '#e5e5e5' }} htmlFor="password" className="form-label">
                        Password:
                      </label>
                      <Form.Control
                        type="password"
                    ...
                    <div className="mb-3">
                      <label style={{ color: '#e5e5e5' }} htmlFor="confirmpassword" className="form-label">
                        Confirm password
                      </label>
                      <input
                        type="password"
                        id="confirmpassword"
                        value={state1.confirmpassword}
                    ...
                    <div className="mb-3 d-flex justify-content-center">
                      <button className='category-button' onClick={Handlesubmit}>Go to stage 2</button>
                    </div>
                  </>
                )}
              </div>
                ...
                {addph && (
                  <>
                    ...
                    <div className="mb-5 d-flex justify-content-center">
                      {!verify && (
                        <>
                          <button className='category-button' onClick={Genotp}>Send OTP</button>
                        </>
                      )}
                    </div>
                    ...
                    <div>
                      {verify && sig && (
                        <>
                          ...
                          />
                          <button className='category-button' onClick={VerifyOtp}>Verify OTP</button>
                        </>
                      )}
                    </div>
                    <div>
                      {!sig && (
                        <>
                          <button className='category-button' onClick={Handlesubmit1}>Sign in</button>
                        </>
                      )}
                    </div>
                  </>
